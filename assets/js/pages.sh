...
terser ./login.js -c -o ../min/pages/login.js
...
terser ./pages/cost.js -c -o ../min/pages/cost.js
terser ./pages/customer.js -c -o ../min/pages/customer.js
terser ./pages/debt.js -c -o ../min/pages/debt.js
...
terser ./pages/reportdesign.js -c -o ../min/pages/reportdesign.js
terser ./pages/statis.js -c -o ../min/pages/statis.js
terser ./pages/stockquery.js -c -o ../min/pages/stockquery.js
terser ./pages/systemset.js -c -o ../min/pages/systemset.js
