...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(buyin::fetch_product_buyin)
            .service(buyin::fetch_one_product)
            .service(buyin::save_document)
            .service(buyin::save_document_sale)
            .service(buyin::save_transport)
            ...
            .service(buyin::fetch_sale_saved_docs)
            .service(buyin::save_sale_money)
            .service(buyin::get_customer_po)
            ...
            .service(material::make_rk_complete)
            ...
            .service(documentquery::documents_fei)
